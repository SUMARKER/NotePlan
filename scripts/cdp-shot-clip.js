'use strict';
/* 通过 CDP Page.captureScreenshot 的 clip+scale 抓取放大局部图。 */
...
const OUT = process.argv[2] || path.join(__dirname, '..', 'shot-clip.png');
const X = +process.argv[3] || 0, Y = +process.argv[4] || 0;
const W = +process.argv[5] || 800, H = +process.argv[6] || 600;
const SCALE = +process.argv[7] || 2;
